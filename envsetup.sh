...
function cconfigs
{
    ...
    local tina_config_dir="$T/device/config/chips/${TARGET_PLATFORM}/configs/${TARGET_BOARD##*-}"
...
{
	if [ ! -d ./dl ];then
		echo "This is your first time use the SDK, please wait a moment."
		echo "Extracting packages ..."
		cat .dl0/* .dl1/* .dl2/* > .dl0/dl.tar
		tar -xf .dl0/dl.tar -C ./
		rm -rf .dl0/dl.tar
	fi
...
[ -e ./build/lind-envsetup.sh ] && source ./build/lind-envsetup.sh
