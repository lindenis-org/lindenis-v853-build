...
PREBUILT_SRC:=$(if $(HOST_PREBUILT_SRC),$(HOST_PREBUILT_SRC),$(TOPDIR)/tools/prebuilt/$(PKG_NAME))
define HostPrebuilt/Prepare
	@echo "HostPrebuilt/Prepare $$@"
	$(CP) $(PREBUILT_SRC)/* $(HOST_BUILD_DIR)/
endef
...
ifeq ($(HOST_PREBUILT_MAKE),1)
		cd $(STAGING_DIR_HOST) &&  git add -f .  &&  git commit --allow-empty -sm "GitHostPrebuilt: $(PKG_NAME) $(if $(PKG_VERSION),$(PKG_VERSION))" && cd -
endif
  ...
  ifndef STAMP_BUILT
	...
	@echo "Action Prepare Finished"
    compile: host-compile
	@echo "Action Compile Finished"
    install: host-install
	@echo "Action Install Finished"
    clean: host-clean
	@echo "Action Clean Finished"
    update: host-update
